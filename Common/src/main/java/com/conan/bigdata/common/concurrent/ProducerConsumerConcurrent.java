 ...
 *
 * 一个生产者，一个消费者，并且让他们让他们使用同一个共享资源，并且我们期望的是生产者生产一条放到共享资源中，消费者就会对应地消费一条
 *
...
class Producer implements Runnable {
    ...
    public Producer(ProducerConsumerConcurrent producerConsumerConcurrent) {
...
class Consumer implements Runnable {
    ...
    public Consumer(ProducerConsumerConcurrent producerConsumerConcurrent) {
        this.producerConsumerConcurrent = producerConsumerConcurrent;
    }
